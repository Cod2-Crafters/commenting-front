...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute left-[17px] top-[16.5px] rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-black data-[state=open]:text-muted-foreground">
        <CloseIcon className="flex items-end text-white" />
        {/* <Cross2Icon className="w-4 h-4 text-left text-white" /> */}

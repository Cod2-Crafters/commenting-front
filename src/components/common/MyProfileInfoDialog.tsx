...
const MyProfileInfoDialog = ({
    ...
    reader.onload = (e) => {
      if (reader.readyState === 2) {
        if (e.target?.result) {
          ...
          modifyProfileFormData.setValue(
            "avatarPath",
  ...
  const imageUpload = async () => {
    const response = await axiosClient.post(
      `/api/profile/${spaceOwnerId}/avatar`,
      formData,
      {
        headers: {
  ...
  return (
    <>
      <Dialog onOpenChange={setIsOpen} open={isOpen}>
        ...
        <DialogContent
          className={`max-w-[600px] min-h-[100px] p-4 ${
            isLoaded ? "visible" : "visible"
          }`}
                            ...
                            return (
                              <>
                                ...
                                <Avatar className="absolute top-0 w-full h-full">
                                  <AvatarImage
                                    className="rounded-full absolute top-0 border-0"
                                  ...
                                  <AvatarFallback>
                                    <Image
                                      className="rounded-full bg-gradient-to-tl to-orange-200 from-stone-100 border-1 border-white absolute w-full h-full"
                        ...
                        <FormField
                          ...
                          render={({ field }) => {
                            return (
                              <FormItem>
                                <FormLabel>
                                  <ProfileLabel htmlFor="input-nickname">
                                    닉네임
                                  </ProfileLabel>
                                </FormLabel>
                        ...
                        <FormField
                          ...
                          render={({ field }) => {
                            ...
                            return (
                              <FormItem>
                                <FormLabel>
                                  <ProfileLabel htmlFor="input-mydesc">
                                    자기소개
                                  </ProfileLabel>
                                </FormLabel>

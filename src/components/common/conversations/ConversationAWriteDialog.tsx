...
const ConversationAWriteDialog = ({
  setIsOpen,
  isOpen,
  trigger,
  mstId,
  onSubmitT,
}: ConversationAWriteDialogProps) => {
  const { showerGuestId, spaceOwnerId, writeMaxMstId, guestProfileData } =
    useSpaceContext();
          ...
          <form
            onSubmit={
              onSubmitT
                ...
                : writeForm.handleSubmit(onSubmit, onInvalid)
            }
          >
            <>
                              ...
                              <FormControl>
                                <>
                                  <Textarea
                                    ...
                                    maxLength={500}
                                  />
                                  {writeForm.formState.errors.content && (
                                    <FormError
                                      message={
                                        writeForm.formState.errors.content
                                          .message
